def quitting():
    if data.find ( 'wikipedia/matthewrbowker' ) != -1: # Check for operator's Wikipedia cloak
...
#	cur.execute()
#	text=cur.fetchone()
#	irc.send ('Showing help for function "' + helpfunc + '": ' + text + '\r\n'
